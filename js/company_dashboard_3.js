    ...
    const labels = [
        {
            ...
            tableData: [
                ...
                { label: '4-7년차투자기사검색건수', value: '0.5', barSegments: 9, score: 91.3 },
                { label: '4-7년차투자단계', value: '0.5', barSegments: 9, score: 95.8 },
                { label: '4-7년차투자유치금액', value: '687.5', barSegments: 9, score: 97.9 },
                { label: '5년차자본잉여금', value: '8990', barSegments: 9, score: 99.2 },
            ]
        },
        {
            text: 'F2',
            ...
            angle: 45,
            tableData: [
                { label: '4-7년차브랜드지재권종류', value: '0', barSegments: 0, score: 0 },
                { label: '4-7년차상표권등록건수', value: '0', barSegments: 0, score: 0 },
                { label: '4-7년차상표권출원건수', value: '0', barSegments: 0, score: 0 },
                { label: '4-7년차전체기사검색건수', value: '15.3', barSegments: 9, score: 91.8 },
        ...
        },
        {
            ...
            tableData: [
                ...
                { label: '4-7년차특허등록건수', value: '1.5', barSegments: 9, score: 93.1 },
                { label: '4-7년차특허출원건수', value: '4', barSegments: 9, score: 99.1 },
                { label: '4년차특허출원대비등록', value: '0.5', barSegments: 9, score: 90 },
                { label: '5년차특허출원대비등록', value: '0', barSegments: 0, score: 0 },
                { label: '6년차특허출원대비등록', value: '0.3', barSegments: 9, score: 94 },
                { label: '7년차특허출원대비등록', value: '1', barSegments: 9, score: 97.8 },
            ]
        },
        {
            text: 'F4',
            ...
            angle: 135,
            tableData: [
                { label: '4-7년차RND수행건수', value: '1.8', barSegments: 9, score: 99.9 },
                { label: '4년차RND금액', value: '441000000', barSegments: 9, score: 97.1 },
                { label: '5년차RND금액', value: '425000000', barSegments: 9, score: 97.3 },
                { label: '6년차RND금액', value: '1034000000', barSegments: 9, score: 99.3 },
        ...
        },
        {
            ...
            angle: 180,
            tableData: [
                { label: '4-7년차성과기사제목검색건수', value: '0.3', barSegments: 8, score: 86.9 },
                { label: '5년차고용인원증가율', value: '0.7', barSegments: 9, score: 96.7 },
                { label: '6년차고용인원증가율', value: '0.3', barSegments: 9, score: 93.5 },
        ...
        },
        {
            ...
            angle: 225,
            tableData: [
                { label: '4년차공시지가', value: '245', barSegments: 9, score: 9.7 },
                { label: '4년차임금', value: '3.4', barSegments: 6, score: 64.7 },
                { label: '4년차퇴사대비입사율', value: '1.8', barSegments: 7, score: 76.1 },
                { label: '5년차공시지가', value: '616', barSegments: 2, score: 23.8 },
                { label: '5년차임금', value: '3.7', barSegments: 7, score: 72.6 },
                { label: '5년차퇴사대비입사율', value: '11', barSegments: 9, score: 99.9 },
                { label: '6년차공시지가', value: '677', barSegments: 2, score: 29.1 },
                { label: '6년차임금', value: '3.8', barSegments: 7, score: 71 },
                { label: '6년차임금증가율', value: '0', barSegments: 3, score: 37.9 },
                { label: '6년차퇴사대비입사율', value: '1.6', barSegments: 8, score: 83.2 },
                { label: '7년차공시지가', value: '711', barSegments: 3, score: 32.6 },
                { label: '7년차퇴사대비입사율', value: '0.2', barSegments: 3, score: 37.8 },
            ]
        },
        {
            text: 'F7',
            ...
            angle: 270,
            tableData: [
                { label: '4-7년차해외진출기사검색건수', value: '0.8', barSegments: 9, score: 90.4 },
            ]
        },
        {
            text: 'F8',
            ...
            angle: 315,
            tableData: [
                { label: '4-7년차초격차RND건수', value: '0.8', barSegments: 9, score: 99 },
            ]
        },
    ];
