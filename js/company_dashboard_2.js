    ...
    const labels = [
        {
            ...
            angle: 0,
            tableData: [
                { label: '4-7년차투자건수', value: '0.2', barSegments: 9, score: 94.2 },
                { label: '4-7년차투자기사검색건수', value: '3.7', barSegments: 9, score: 97.6 },
                { label: '4-7년차투자단계', value: '0.7', barSegments: 9, score: 97.5 },
                { label: '4-7년차투자유치금액', value: '1433.3', barSegments: 9, score: 98.9 },
                { label: '5년차자본잉여금', value: '139', barSegments: 8, score: 86.2 },
            ]
        },
        {
            text: 'F2',
            ...
            angle: 45,
            tableData: [
                { label: '4-7년차브랜드지재권종류', value: '1.3', barSegments: 9, score: 98.1 },
                { label: '4-7년차상표권등록건수', value: '2.7', barSegments: 9, score: 95.3 },
                { label: '4-7년차상표권출원건수', value: '2.7', barSegments: 9, score: 94.3 },
                { label: '4-7년차전체기사검색건수', value: '63.3', barSegments: 9, score: 98.5 },
                { label: '5년차상표권출원대비등록', value: '0', barSegments: 0, score: 0 },
                { label: '6년차상표권출원대비등록', value: '0', barSegments: 0, score: 0 },
                { label: '7년차상표권출원대비등록', value: '-', barSegments: 0, score: '-' },
            ]
        },
        {
            text: 'F3',
            ...
            angle: 90,
            tableData: [
                { label: '4-7년차기술인증종류현황', value: '2', barSegments: 9, score: 96.8 },
                { label: '4-7년차연구소인증건수', value: '0', barSegments: 0, score: 0 },
                { label: '4-7년차특허등록건수', value: '5.7', barSegments: 9, score: 99.6 },
                { label: '4-7년차특허출원건수', value: '5', barSegments: 9, score: 99.6 },
                { label: '4년차특허출원대비등록', value: '0.2', barSegments: 8, score: 88.2 },
                { label: '5년차특허출원대비등록', value: '2.3', barSegments: 9, score: 99.3 },
                { label: '6년차특허출원대비등록', value: '6', barSegments: 9, score: 99.9 },
                { label: '7년차특허출원대비등록', value: '-', barSegments: 0, score: '-' },
            ]
        },
        {
            text: 'F4',
            ...
            angle: 135,
            tableData: [
                { label: '4-7년차RND수행건수', value: '0.3', barSegments: 8, score: 87.9 },
                { label: '4년차RND금액', value: '357500000', barSegments: 9, score: 96.3 },
                { label: '5년차RND금액', value: '317500000', barSegments: 9, score: 96.5 },
                { label: '6년차RND금액', value: '0', barSegments: 0, score: 0 },
                { label: '7년차RND금액', value: '-', barSegments: 0, score: '-' },
            ]
        },
        {
            text: 'F5',
            ...
            angle: 180,
            tableData: [
                { label: '4-7년차성과기사제목검색건수', value: '10.7', barSegments: 9, score: 99.8 },
                { label: '5년차고용인원증가율', value: '0.4', barSegments: 8, score: 89.5 },
                { label: '6년차고용인원증가율', value: '-', barSegments: 0, score: 0 },
        ...
        },
        {
            ...
            angle: 225,
            tableData: [
                { label: '4년차공시지가', value: '645', barSegments: 2, score: 23.8 },
                { label: '4년차임금', value: '3.6', barSegments: 7, score: 74.7 },
                { label: '4년차퇴사대비입사율', value: '2.6', barSegments: 8, score: 89.7 },
                { label: '5년차공시지가', value: '645', barSegments: 2, score: 24.6 },
                { label: '5년차임금', value: '3.8', barSegments: 7, score: 76.3 },
                { label: '5년차퇴사대비입사율', value: '1.7', barSegments: 8, score: 80.4 },
                { label: '6년차공시지가', value: '645', barSegments: 2, score: 28.2 },
                { label: '6년차임금', value: '-', barSegments: 0, score: '-' },
                { label: '6년차임금증가율', value: '-', barSegments: 0, score: '-' },
                { label: '6년차퇴사대비입사율', value: '0.5', barSegments: 3, score: 38.1 },
                { label: '7년차공시지가', value: '-', barSegments: 0, score: '-' },
                { label: '7년차퇴사대비입사율', value: '-', barSegments: 0, score: '-' },
            ]
        },
        {
            text: 'F7',
            ...
            angle: 270,
            tableData: [
                { label: '4-7년차해외진출기사검색건수', value: '3.7', barSegments: 9, score: 96.5 },
            ]
        },
        {
            text: 'F8',
            ...
            angle: 315,
            tableData: [
                { label: '4-7년차초격차RND건수', value: '0.3', barSegments: 9, score: 93.7 },
            ]
        },
    ];
